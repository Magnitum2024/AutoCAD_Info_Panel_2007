...
- После импорта XLSX в настройках сохраняются имя/полный путь/папка и CRC32 файла; при периодической проверке хеша (`XLSX.HashCheckMinutes`, по умолчанию 10 минут) вверху панели показывается имя файла: красным цветом при изменении хеша и обычным цветом если файл не изменился.
